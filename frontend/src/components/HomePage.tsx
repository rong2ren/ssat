...
export function HomePage({ showChinese = false }: HomePageProps) {
  ...
  const translations = {
    ...
    'AI-Powered Questions': 'AI优化题目',
    'Get practice questions that match the SSAT format and difficulty, powered by advanced AI models.':
    '获取由先进AI模型优化的、符合SSAT格式和难度的练习题。',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">{t('AI-Powered Questions')}</h3>
              <p className="text-gray-600 leading-relaxed">
                {t('Get practice questions that match the SSAT format and difficulty, powered by advanced AI models.')}
              </p>
            </div>
